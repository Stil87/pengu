...
class Repository {
  ...
  Future<String> signInFirebaseAuthWithEmail(String email, String password) =>
      _userAuthProvider.signInFirebaseAuthWithEmail(email, password);
  ...
  Future<String> createFirebaseAuthUserWithEmail(
      ...
      _userAuthProvider.signUpFirebaseAuthWithEmail(email, password);
  ...
  Future<String> addUserToFirebaseStoreCollection(User user) =>
      _userAuthProvider.addUserToFirebaseStoreCollection(user);
  ...
  Future<bool> checkUserExistInFirestoreCollection(String userID) =>
      _userAuthProvider.checkUserExistInFirestoreCollection(userID);
  ...
  Stream<User> getUserFomFirestoreCollection(String userID) =>
      _userAuthProvider.getUserFomFirestoreCollection(userID);
  ...
  Stream<FirebaseUser> checkUserSignedInWithFirebaseAuth() =>
      _userAuthProvider.checkUserSignedInWithFirebaseAuth();
